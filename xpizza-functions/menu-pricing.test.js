...
assert.deepStrictEqual(computeServerTotal([{ id: 'noodle_01', qty: 1 }], 'la_musa'), { total: 414, error: null }); ok('la_musa launcher noodle_01 priced at safe max 414 (cannot underpay any protein)');
