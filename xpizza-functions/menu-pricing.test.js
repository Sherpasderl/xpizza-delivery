...
const LA_MUSA_MENU_EXPECTED = {
  ...
  noodle_01_sin: 307, noodle_01_pollo: 342, noodle_01_camaron: 414, noodle_02: 492, noodle_03: 340,
...
assert.equal(Object.keys(MENU_BY_RESTAURANT.la_musa).length, 42); ok('la_musa has exactly 42 items');
...
ok('all 42 la_musa ids price exactly');
...
assert.equal(computeServerTotal([{ id: 'noodle_01', qty: 1 }], 'la_musa').error !== null, true); ok('la_musa bare launcher noodle_01 rejected (unorderable)');
