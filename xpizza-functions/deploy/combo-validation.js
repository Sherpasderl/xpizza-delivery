...
const COMBOS = {
  cash_delivery: {
    ...
    pre3b: {
      ...
      'tasks/ORD1_pickup': { order_id: 'ORD1', restaurant_id: 'x_pizza', type: 'pickup', status: 'pending', assigned_driver_id: null, linked_task_id: 'ORD1_delivery', depends_on_task_id: null, destination_lat: 15.507489753573818, destination_lng: -88.0398486953722, destination_address: 'X Pizza', recipient_name: 'X Pizza', recipient_phone: '+50497952893', notes: 'Pizza x1', created_at: 111 },
